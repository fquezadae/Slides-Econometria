...
subtitle: "Censura, Truncamiento, Selección (Tobit y Heckman)"
...
La función de densidad de  $y_i^*$ , condicional a que  $y_i^* > L$  (truncamiento por debajo), es:
...
La función de log-verosimilitud para el modelo de regresión truncada es:
